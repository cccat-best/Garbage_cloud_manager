package org.sipc.tclserver.util;
...
public class TimeTransUtil {
    ...
    private final static DateTimeFormatter DAY_TIME_FORMATTER =  DateTimeFormatter.ofPattern("yyyy-MM-dd", Locale.CHINA);
    ...
    public static String tranStringDay(LocalDateTime time) {
        return time.format(DAY_TIME_FORMATTER);
    }
